...
class StellateCell(DbbsNeuronModel):
    ...
    section_types = {
        ...
        "dendrites": {"synapses": ["GABA"], "mechanisms": [], "attributes": {}},
        "proximal_dendrites": {
            "synapses": ["AMPA", "NMDA"],
            "mechanisms": [
                "Leak",
    ...
    labels = {
        "proximal_dendrites": {"from": "dendrites", "diam": lambda diam: diam >= 0.6},
        "distal_dendrites": {"from": "dendrites", "diam": lambda diam: diam < 0.6},
